...
describe("archive entry names", () => {
  ...
  it("uses English labels for generated export names when requested", () => {
    expect(assignmentGradeFilename("Assignment 3", "en")).toBe("Assignment 3-grades.xlsx");
    expect(allAssignmentsArchiveDirectory("en")).toBe("all-assignments-and-grades");
    expect(studentArchiveDirectory("test001", "", "en")).toBe("test001_unnamed-student");
  });
